...
4. **상담현황** ⭐ NEW
   - **리스트 모드**
     - 테이블 형태로 전체 상담 목록 조회
     - 컬럼: ID, 상태, 고객명, 전화번호, 유입경로, 옵션, 등록일, 등록자, 수정자
     - 행 클릭 시 상세 모달
     - 수정/삭제 버튼
   - **칸반 모드** 🎯
