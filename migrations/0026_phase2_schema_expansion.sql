-- ========================================
-- Migration: Phase 2 스키마 확장 (50개 컬럼 추가)
-- Date: 2026-02-02
-- Purpose: 업무 필수 50개 컬럼을 4개 테이블에 추가
-- ========================================

-- ========================================
-- PART 1: Consultations 테이블 (36개 컬럼 추가)
-- ========================================
...
-- ========================================
-- PART 2: Contracts 테이블 (36개 컬럼 추가)
-- ========================================
...
-- ========================================
-- PART 3: Installations 테이블 (36개 컬럼 추가)
-- ========================================
...
-- ========================================
-- PART 4: Operations 테이블 (34개 컬럼 추가)
-- ========================================
-- 주의: operations는 이미 contract_checked, installation_cert_checked, installation_photo_checked 있음
